...
module.exports = class ServerlessCweSnsLambda {
    ...
    validateConfig(funcName, stage, config) {
        ...
        return {
            ...
            dlqResourceName: "SNSDeadLetterQueue",
    ...
    addSNStoDLQPolicy(template, {prefix, topicArn, dlqArn, dlqUrl, dlqPolicyResourceName}) {
        ...
        template.Resources[dlqPolicyResourceName].Properties.Queues.push(dlqUrl);
    ...
    addTopicSubscription(template, {funcName, topicArn, topicResourceName, dlqArn, filterPolicy}) {
