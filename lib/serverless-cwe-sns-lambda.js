    ...
    constructor(serverless, options) {
        ...
        */
        serverless.configSchemaHandler.defineFunctionEvent('aws', 'cweSns', {
            type: 'object',
            properties: {
                ruleResourceName: ["object", "string"],
                topicArn: ["object", "string"],
                dlqArn: ["object", "string"],
                dlqUrl: ["object", "string"],
                dlqPolicyResourceName: ["object", "string"],
                ruleMessage: ["object", "string"],
                filterPolicy: ["object"]           
            },
