...
module.exports = class ServerlessCweSnsLambda {
    ...
    addSNStoDLQPolicy(template, {prefix, topicResourceName, dlqResourceName}) {
        ...
        template.Resources["SNStoDLQInsertPolicy"].Properties.PolicyDocument.Statement.push({
            Effect: "Allow",
            Principal: {
    ...
    addCWEtoSNSPolicy(template, {prefix, topicResourceName}) {
        ...
        template.Resources["CWEtoSNSInsertPolicy"].Properties.PolicyDocument.Statement.push({
            Effect: "Allow",
            Principal: {
